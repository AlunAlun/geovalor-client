  ...
  return (
    <div className="min-h-screen bg-brand-beige flex flex-col items-center justify-center text-center px-4">
      ...
      <h1 className="text-4xl font-bold text-brand-dark mb-4">
        Bienvenido a Geovalor
      </h1>
      <p className="text-lg text-brand-dark max-w-xl mb-6">
        Conoce los riesgos antes de construir. Geovalor combina datos oficiales de inundaciones, incendios, riesgos sísmicos y desertificación en una única plataforma de riesgo ambiental.
      </p>
      <Link
        to="/login"
